...
console.log(surfaceAreaSphere(1))
console.log(areaRectangle(2, 2))
console.log(areaSquare(2))
console.log(areaTriangle(2, 2))
console.log(areaParallelogram(2, 2))
console.log(areaTrapezium(2, 2, 2))
console.log(areaCircle(2, 2))
console.log(areaRhombus(2, 2))
console.log(areaTriangleWithAllThreeSides(2, 2, 2))