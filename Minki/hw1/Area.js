...
console.log(areaTriangle(2))
console.log(areaParallelogram(2))
console.log(areaTrapezium(2))
console.log(areaCircle(2))
console.log(areaRhombus(2))
console.log(areaTriangleWithAllThreeSides(2))